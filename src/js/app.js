...
console.log("\nBy country:");
displayUsers(sorted(validated, userComparators.byCountry));
console.log("\nBy age:");
displayUsers(sorted(validated, userComparators.byAge));
console.log("\nBy b-day (descending):");
displayUsers(sorted(validated, userComparators.byBday, SortOrder.descending));
console.log("\nBy name:");
displayUsers(sorted(validated, userComparators.byName));
